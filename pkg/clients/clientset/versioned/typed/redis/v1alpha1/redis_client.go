...
import (
	...
	"harmonycloud.cn/middleware-operator-manager/pkg/clients/clientset/versioned/scheme"
...
// CrV1alpha1Client is used to interact with features provided by the cr.example.apiextensions.k8s.io group.
type CrV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrV1alpha1Client) RedisClusters(namespace string) RedisClusterInterface {
