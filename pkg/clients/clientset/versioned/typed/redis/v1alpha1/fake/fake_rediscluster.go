...
var redisclustersResource = schema.GroupVersionResource{Group: "cr.example.apiextensions.k8s.io", Version: "v1alpha1", Resource: "redisclusters"}

var redisclustersKind = schema.GroupVersionKind{Group: "cr.example.apiextensions.k8s.io", Version: "v1alpha1", Kind: "RedisCluster"}
